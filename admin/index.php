...
if ($action == '') {
	if(strpos($user_cache[UID]['avatar'],'stor.sinaapp.com')!==false) $imgurl = '';else $imgurl = '../';
	$avatar = empty($user_cache[UID]['avatar']) ? './views/images/avatar.jpg' : $imgurl . $user_cache[UID]['avatar'];
