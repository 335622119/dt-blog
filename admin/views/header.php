...
<div id="header">
    ...
    <a href="./blogger.php" title="<?php echo subString($user_cache[UID]['name'], 0, 12) ?>">
        <img src="<?php if(strpos($user_cache[UID]['avatar'],'stor.sinaapp.com')!==false) $imgurl = '';else $imgurl = '../';echo empty($user_cache[UID]['avatar']) ? './views/images/avatar.jpg' : $imgurl . $user_cache[UID]['avatar'] ?>" align="top" width="20" height="20" />
    </a><span>|</span>
